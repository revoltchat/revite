import { Bot as BotIcon } from "@styled-icons/boxicons-solid";
...
export default function InviteBot() {
    ...
    return (
        ...
        <div>
            ...
            <div className={styles.inviteBot}>
                    ...
                    <>
                        ...
                        <div className={styles.type}>
                            ...
                            <ComboBox
                                ...
                                <option value="none">Server not selected..</option>
                        ...
                        <div className={styles.type}>
                            ...
                            <ComboBox
                                ...
                                <option value="none">Group not selected..</option>
